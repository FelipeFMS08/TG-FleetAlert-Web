    ...
    return (
        <div className="flex h-screen bg-white dark:bg-zinc-900 relative">
            ...
            <div className="grid grid-cols-[1fr_1fr_0.1fr] grid-row-3 grid-flow-row-dense gap-4 pl-32 pr-10 pb-14 pt-2">
                <UserInfoTrack />
                <DriverScoreTrack />
                <div className="dark:bg-zinc-800 bg-zinc-100 p-4 col-span-2 row-span-2 rounded-md h-[25rem] ">Em codificação</div>
                <div className="grid grid-cols-subgrid gap-4 row-span-3 rounded-md relative z-0">
                    <FleetMap />
                </div>
            </div>
